...
import { googleOAuthService } from "../../../../services/oauth/oauthGoogle.service";
import { githubOAuthService } from "../../../../services/oauth/oauthGithub.service";
...
export const oauthCallback = async (req: Request, res: Response) => {
  ...
  const profile = await service.getUserProfile(code, state);
